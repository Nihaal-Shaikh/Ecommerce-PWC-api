                        ...
                        <div class="card">
                            <div class="card-body">
                                <ul class="list-group">
                                    ...
                                    <li class="list-group-item"><strong><span class="text-dark">Product Colour: </span></strong>{{$order->colour }}</li>
                                    <li class="list-group-item"><strong><span class="text-dark">Quantity: </span></strong>{{$order->quantity }}</li>
