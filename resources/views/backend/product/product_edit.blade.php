                            ...
                            <div class="col-lg-4">
                                <div class="border border-3 p-4 rounded">
                                    <div class="row g-3">
                                        ...
                                        <div class="form-check">
                                            <input class="form-check-input" name="remark" type="checkbox" value="NEW" id="flexCheckNew" {{ $product->remark == 'NEW' ? 'checked' : '' }}>
                                            <label class="form-check-label" for="flexCheckNew">NEW</label>
                                        </div>

                                        <div class="form-check">
                                            <input class="form-check-input" name="remark" type="checkbox" value="COLLECTION" id="flexCheckCollection" {{ $product->remark == 'COLLECTION' ? 'checked' : '' }}>
